...
describe('Testing modules/moduleLoader.ts in a jsdom environment', () => {
    ...
    test('Loading a module bundle correctly', () => {
        ...
        const loadedBundle = moduleLoader.loadModuleBundle('module', (0, createContext_1.createEmptyContext)(1, 'default', []));
    ...
    test('Loading a wrongly implemented module bundle throws ModuleInternalError', () => {
        ...
        expect(() => moduleLoader.loadModuleBundle('module', (0, createContext_1.createEmptyContext)(1, 'default', []))).toThrow(moduleErrors_1.ModuleInternalError);
    });
