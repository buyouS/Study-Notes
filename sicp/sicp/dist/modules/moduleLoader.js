...
exports.appendModuleTabsToContext = exports.loadModuleTabs = exports.convertRawTabToFunction = exports.loadModuleBundle = exports.memoizedGetModuleFile = exports.memoizedGetModuleManifest = exports.httpGet = exports.setModulesStaticURL = exports.MODULES_STATIC_URL = exports.newHttpRequest = void 0;
 ...
 * @param context
 */
function appendModuleTabsToContext(program, context) {
    // Rest the modules to empty array everytime
    context.modules = [];
    for (const node of program.body) {
        if (node.type === 'ImportDeclaration') {
            if (!node.source.value)
                throw new moduleErrors_1.ModuleNotFoundError('', node);
...
exports.appendModuleTabsToContext = appendModuleTabsToContext;
