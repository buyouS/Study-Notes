...
exports.typedParse = exports.looseParse = exports.parseForNames = exports.tokenize = exports.parse = exports.parseAt = exports.TrailingCommaError = exports.MissingSemicolonError = exports.FatalSyntaxError = exports.DisallowedConstructError = void 0;
...
function parse(source, context) {
    let program;
    try {
        program = (0, acorn_1.parse)(source, createAcornParserOptions(context));
...
function tokenize(source, context) {
    return [...(0, acorn_1.tokenizer)(source, createAcornParserOptions(context))];
}
...
function looseParse(source, context) {
    const program = (0, acorn_loose_1.parse)(source, createAcornParserOptions(context));
    return program;
}
