 ...
 */
function testForInfiniteLoop(code, previousCodeStack) {
    const context = (0, index_1.createContext)(4, 'default', undefined, undefined);
    ...
    const sandboxedRun = new Function('code', functionsId, stateId, builtinsId, constants_1.MODULE_PARAMS_ID, 
